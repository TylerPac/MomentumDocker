package dev.tylerpac.momentum.exception;
...
import dev.tylerpac.momentum.dto.common.ApiError;
import dev.tylerpac.momentum.dto.common.ApiFieldError;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ApiFieldError> handleValidationException(ValidationException ex) {
        ...
        return ResponseEntity.status(status.value()).body(new ApiFieldError(message, ex.getFieldErrors()));
    }
